...
function buildAccountConfigs(): Map<string, AccountConfig> {
    ...
    envKeys.forEach(key => {
        ...
        if (oauthMatch) accountNames.add(oauthMatch[1].toLowerCase());
        if (credsMatch) accountNames.add(credsMatch[1].toLowerCase());
    });
